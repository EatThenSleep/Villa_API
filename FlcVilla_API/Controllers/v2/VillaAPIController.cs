    ...
    public class VillaAPIController : ControllerBase
    {
                                                               ...
                                                               int pageSize = 0, int pageNumber = 1)
        {
            try
            {
                ...
                if (pageSize > 0)
                {
                    villaList = villaList.Skip(pageSize * (pageNumber - 1)).Take(pageSize);
        ...
        public async Task<ActionResult<APIResponse>> GetVilla(int id)
        {
            try
            {
                if (id == 0)
                {
                    ...
                    _response.IsSuccess = false;
                    _response.AppendMessage("Làm đéo gì có Id = 0");
                ...
                if (villa == null)
                {
                    ...
                    _response.IsSuccess = false;
                    _response.AppendMessage("Mày đùa tao à");
        ...
        public async Task<ActionResult<APIResponse>> CreateVilla([FromForm] VillaCreateDTO createDTO)
        {
            try
            {
                ...
                if(createDTO.Image != null)
                {
                    ...
                    // configure for https, port number, path 
